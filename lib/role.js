...
module.exports = {
    ...
    const sql = 'SELECT r.title, r.salary, d.name as department FROM role as r \
    ...
    const sql = 'DELETE FROM role WHERE (title) IN (?)'; 
    ...
    inqRole: function (depts, callback) {
        console.log(depts);
        inquirer.prompt([{
            type: 'input',
            name: 'title', 
